...
//const shownotesbtn=document.getElementsByClassName("shownotes")[0];//
let cancelbtn=document.getElementsByClassName("cancel")[0];
//let shownotes=document.getElementsByClassName("notes")[0];//
...
function createFetchApi(e){
    ...
    if(noteId){
        ...
        fetch(`https://ekwvioyykteghvotgimj.supabase.co/rest/v1/notes?id=eq.${noteId}`, {
...
if(noteId){
    ...
    fetch(`https://ekwvioyykteghvotgimj.supabase.co/rest/v1/notes?id=eq.${noteId}&select=*`, {
